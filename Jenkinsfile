pipeline {
    environment {
        ...
        APP_EXPOSED_PORT = "80"
        IMAGE_TAG = "latest"
        STAGING = "lickapp-staging"
        PRODUCTION = "lickapp-prod"
        DOCKERHUB_ID = "sarrlick"
        DOCKERHUB_PASSWORD = credentials('dockerhub_password')
        APP_NAME = "lick"
        STG_API_ENDPOINT = "ip10-0-3-3-cka580ct654gqaevke3g-1993.direct.docker.labs.eazytraining.fr"
        STG_APP_ENDPOINT = "ip10-0-3-3-cka580ct654gqaevke3g-80.direct.docker.labs.eazytraining.fr"
        PROD_API_ENDPOINT = "ip10-0-3-4-cka580ct654gqaevke3g-1993.direct.docker.labs.eazytraining.fr"
        PROD_APP_ENDPOINT = "ip10-0-3-4-cka580ct654gqaevke3g-80.direct.docker.labs.eazytraining.fr"
        INTERNAL_PORT = "5000"
    ...
    stages {
       ...
       stage('Test image') {
           ...
           steps {
              script {
                sh '''
                   curl -v http://172.17.0.1:${PORT_EXPOSED} | grep -i "Dimension"
                '''
              }
           }
       }
