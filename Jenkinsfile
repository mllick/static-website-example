pipeline {
     environment {
       ...
       APP_NAME = "lick"
       STG_API_ENDPOINT = "ip10-0-0-3-ckabqvkt654gqaevkeb0-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-0-3-ckabqvkt654gqaevkeb0-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-0-4-ckabqvkt654gqaevkeb0-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-0-4-ckabqvkt654gqaevkeb0-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
     ...
     stages {
      ...
      stage('Save Artefact') {
          ...
          steps {
             script {
               sh '''
                 docker save  ${ID_DOCKER}/$IMAGE_NAME:$IMAGE_TAG > /tmp/staticwebsite.tar                 
               '''
             }
          }
     }          
