pipeline {
     environment {
       ...
       APP_NAME = "lick"
       STG_API_ENDPOINT = "ip10-0-0-4-ck9gt6ct654gqaevkd50-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-0-4-ck9gt6ct654gqaevkd50-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "http://ip10-0-0-5-ck9gt6ct654gqaevkd50-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "http://ip10-0-0-5-ck9gt6ct654gqaevkd50-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "8080"
     ...
     stages {
       ...
       stage('Test image') {
           ...
           steps {
              script {
                sh '''
                    curl http://localhost:${PORT_EXPOSED} | grep -i "Dimension"
                '''
              }
           }
      }
