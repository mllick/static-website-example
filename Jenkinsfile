pipeline {
    environment {
        ...
        APP_NAME = "lick"
        STG_API_ENDPOINT = "ip10-0-2-3-cekvhqgmjkegg872c7ig-1993.direct.docker.labs.eazytraining.fr"
        STG_APP_ENDPOINT = "ip10-0-2-3-cekvhqgmjkegg872c7ig-8080.direct.docker.labs.eazytraining.fr"
        PROD_API_ENDPOINT = "ip10-0-2-3-cekvhqgmjkegg872c7ig-1993.direct.docker.labs.eazytraining.fr"
        PROD_APP_ENDPOINT = "ip10-0-2-3-cekvhqgmjkegg872c7ig-80.direct.docker.labs.eazytraining.fr"
        INTERNAL_PORT = "5000"
