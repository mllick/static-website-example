pipeline {
     environment {
       ...
       APP_NAME = "lick"
       STG_API_ENDPOINT = "ip10-0-0-3-ckad35kt654gqaevkecg-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-0-3-ckad35kt654gqaevkecg-80.direct.docker.labs.eazytraining.fr"
